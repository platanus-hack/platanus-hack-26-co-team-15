...
Archivo for headings over Archivo for body text, loaded as `--font-heading` / `--font-body`. Density 1.00x and radius 0px are already baked into the `--space-*` / `--radius-*` scales — use the variables, not raw numbers.
